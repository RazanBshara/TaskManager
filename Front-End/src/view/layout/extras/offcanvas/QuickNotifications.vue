<template>
  <div class="topbar-item">
    <div id="kt_quick_notifications_toggle">
      <b-icon icon="bell-fill" class="rounded-circle btn btn-icon btn-sm btn-primary bg-danger p-2" variant="light"></b-icon>
...
<!-- t3le2 lnoti lmorb3 la7mar rkm 3 kman import w mounted Yaraaazzzz!!!!!!!!!!!!!!!!!!!!!!!!-->
<script>
