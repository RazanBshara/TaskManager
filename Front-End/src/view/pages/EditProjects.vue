<template>
  <div>
    <b-nav class="mx-1">
      <b-nav-item class="text-muted" v-on:click="$router.push('projects')">
        <b-icon icon="chevron-left"></b-icon>
        Projects
      </b-nav-item>
      <br /><br /><br />
      <b-item class="font-size-h1 font-weight-weight">Edit Project</b-item>
    </b-nav>
            ...
            <div class="wizard-steps p-8 p-lg-10">
              ...
              >
                <div class="wizard-label">
                  ...
                  <h3 class="wizard-title">1. Edit Your Project</h3>
                </div>
              </div>
            </div>
          </div>
                ...
                >
                  ...
                  <div class="form-group">
                    ...
                    <span class="form-text text-muted"
                      >Please enter your project name</span
                    >
                  </div>
...
export default {
  ...
  methods: {
    onSubmit() {
      axios({
        method: "put",
        url: `http://127.0.0.1:8000/api/project/${this.projectid}`,
        data: {
  ...
  created: function() {
    axios({
      method: "get",
      url: `http://127.0.0.1:8000/api/project/${this.projectid}/edit`,
      headers: {
        Accept: "application/json",
        Authorization: "Bearer " + localStorage.getItem("Token"),
      },
