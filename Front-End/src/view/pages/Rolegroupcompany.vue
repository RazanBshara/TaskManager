  ...
  <div class="card card-custom card-stretch gutter-b card-shadowless bg-light">
    ...
    <div class="card-header border-0 py-5">
      <h3 class="card-title align-items-start flex-column">
        <span class="card-label font-weight-bolder text-dark"> Rolegroup company </span>
        <!--span class="text-muted mt-3 font-weight-bold font-size-sm">
          More than 400+ new members
        </span-->
      </h3>
      <div class="card-toolbar" v-on:click="$router.push('addrolegroupcompany')">
        <a href="#" class="btn btn-success font-weight-bolder font-size-sm">
          Add a New rolegroup company</a
        >
      </div>
    </div>
    <!--end::Header-->
        ...
        >
          <thead>
            <tr class="text-left">
              ...
              <th style="min-width: 150px">Adjective</th>
      ...
      list: [
        {
          ...
          text1: "Rolegroupcompany 1",
          ///text2: "HTML, JS, ReactJS",
          text3: "InterticoKLMSJJJHjhVSAJfjhBAJSfhvashvcfhvahjcv",
